...
import dan200.computercraft.core.engine.MachineResult
import kotlinx.coroutines.*
import kotlin.coroutines.CoroutineContext

/**
 * An [IMachine] which runs Kotlin functions instead.
 */
abstract class KotlinMachine(environment: MachineEnvironment) : IMachine, AbstractLuaTaskContext() {
    override val context: IContext = environment.context
     ...
     */
    protected abstract fun getTask(): (suspend KotlinMachine.() -> Unit)?
