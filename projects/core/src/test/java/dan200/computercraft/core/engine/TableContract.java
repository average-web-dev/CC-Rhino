...
/**
 * Test Interface defining the behaviour of a {@link ScriptTable} implementation.
 *
 * @param <T> The implementation of {@link ScriptTable} we are testing.
 */
public interface TableContract<T extends ScriptTable<?, ?>> {
    T create(Map<?, ?> map);
    ...
    default void testGetIntLikeKey() {
        ...
        // the only number) and we don't need to handle double/int normalisation within ObjectTable.
    ...
    @Test
    default void testGetInt() throws ScriptException {
