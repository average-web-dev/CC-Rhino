...
public class LuaUtil {
    ...
    public static <T> T getField(Map<?, ?> table, String key, Class<T> type) throws LuaException {
        ...
        throw LuaValues.badField(key, expectedTypeName(wrapped), LuaValues.getType(value));
    }
     ...
     * @throws LuaException If any field is missing or of the wrong type.
     */
    public static <T> T toRecord(Map<?, ?> table, Class<T> type) throws LuaException {
