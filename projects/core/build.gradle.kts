...
dependencies {
    ...
    // Use direct JARs instead of the POM-only js-community wrappers (Fabric Loom crashes on POM files in classpath)
    runtimeOnly(libs.graaljs.js.language)
    runtimeOnly(libs.graaljs.truffle.runtime)
