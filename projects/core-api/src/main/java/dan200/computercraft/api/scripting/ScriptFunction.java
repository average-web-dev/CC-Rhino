 ...
 * <p>
 * Methods annotated with {@link ScriptFunction} must be public final instance methods. They can have any number of
 * parameters, but they must be of the following types:
 *
 * <ul>
 *   <li>{@link IContext} (and {@link IComputerAccess} if on a {@link IPeripheral})</li>
