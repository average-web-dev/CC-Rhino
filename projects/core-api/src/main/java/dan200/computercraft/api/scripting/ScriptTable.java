...
import static dan200.computercraft.api.scripting.ScriptValues.*;
 ...
 * @see ObjectArguments
 */
public interface ScriptTable<K, V> extends Map<K, V> {
    /**
     ...
     * @since 1.116
     */
    default double getDouble(String key) throws ScriptException {
     ...
     * @throws ScriptException If the value is not an integer.
     */
    default long getLong(String key) throws ScriptException {
        Object value = get(key);
        if (!(value instanceof Number number)) throw badField(key, "number", getType(value));
     ...
     * @throws ScriptException If the value is not an integer.
     */
    default int getInt(String key) throws ScriptException {
     ...
     * @since 1.116
     */
    default double getFiniteDouble(String key) throws ScriptException {
     ...
     * @since 1.116
     */
    default boolean getBoolean(String key) throws ScriptException {
        Object value = get(key);
     ...
     * @since 1.116
     */
    default String getString(String key) throws ScriptException {
        Object value = get(key);
     ...
     * @since 1.116
     */
    default Map<?, ?> getTable(String key) throws ScriptException {
        Object value = get(key);
     ...
     * @since 1.116
     */
    default Optional<Double> optDouble(String key) throws ScriptException {
        Object value = get(key);
        if (value == null) return Optional.empty();
        if (!(value instanceof Number number)) throw badField(key, "number", getType(value));
        return Optional.of(number.doubleValue());
     ...
     * @since 1.116
     */
    default Optional<Long> optLong(String key) throws ScriptException {
        Object value = get(key);
        if (value == null) return Optional.empty();
        if (!(value instanceof Number number)) throw badField(key, "number", getType(value));
        checkFiniteField(key, number.doubleValue());
     ...
     * @since 1.116
     */
    default Optional<Integer> optInt(String key) throws ScriptException {
     ...
     * @since 1.116
     */
    default Optional<Double> optFiniteDouble(String key) throws ScriptException {
     ...
     * @since 1.116
     */
    default Optional<Boolean> optBoolean(String key) throws ScriptException {
        Object value = get(key);
        if (value == null) return Optional.empty();
        if (!(value instanceof Boolean bool)) throw badField(key, "boolean", getType(value));
        return Optional.of(bool);
     ...
     * @since 1.116
     */
    default Optional<String> optString(String key) throws ScriptException {
        Object value = get(key);
        if (value == null) return Optional.empty();
        if (!(value instanceof String string)) throw badField(key, "string", getType(value));
        return Optional.of(string);
     ...
     * @since 1.116
     */
    default Optional<Map<?, ?>> optTable(String key) throws ScriptException {
        Object value = get(key);
        if (value == null) return Optional.empty();
        if (!(value instanceof Map<?, ?> table)) throw badField(key, "table", getType(value));
        return Optional.of(table);
    ...
    default V put(K o, V o2) {
        throw new UnsupportedOperationException("Cannot modify ScriptTable");
    }
